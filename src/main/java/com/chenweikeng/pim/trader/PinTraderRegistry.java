...
public class PinTraderRegistry {
    ...
    private void initializeTraders() {
        ...
        PinTraderLocation rushinRiverOutfitters = addLocation("Rushin' River Outfitters", "rushinriveroutfitters");
        PinTraderLocation runawayRailway = addLocation("Mickey & Minnie's Runaway Railway", "runawayrailway");
