...
public class PinRarityHandler {
    ...
    private void flushUpdates() {
        ...
        if (player != null) {
            player.displayClientMessage(Component.literal("§6✨ §e[Pim] §fThe pin rarity information has been updated for §e" + pendingUpdatedCount + "§f pin pack" + (pendingUpdatedCount == 1 ? "" : "s") + ". There " + (seriesMap.size() == 1 ? "is" : "are") + " §e" + seriesMap.size() + "§f pin pack" + (seriesMap.size() == 1 ? "" : "s") + " on record."), false);
        }
