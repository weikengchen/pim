...
public class InventoryHandler {
    ...
    public List<String> recomputeCache(NonNullList<Slot> slots) {
        ...
        for (Slot slot : slots) {
            ...
            PinDetailHandler.PinDetailEntry parsedEntry = PinDetailHandler.getInstance().parsePinEntry(itemStack);
            ...
            PinDetailHandler.PinDetailEntry existingEntry = PinDetailHandler.getInstance().findDetailEntry(pinSeries, parsedEntry.pinName);
